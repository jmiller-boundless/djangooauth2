"""
Django settings for mozoidc project.
...
SECRET_KEY = '#cpdx!#k0ttnes%+)-9wx6#)w90b^c&)qvz4!(qkj!4h3ry5pe'
...
WSGI_APPLICATION = 'mozoidc.wsgi.application'
